...
from hikVision.config import host, app_key
from hikVision.signature import Signature
from hikVision.services.cameraCapture import (
    cameraCapture,
...
if __name__ == "__main__":
    camera_index_code = "1"
    while True:
        patrol_with_capture(camera_index_code, patrol_schedule)
        time.sleep(10)  # optional pause before restarting the whole patrol
